...
check('hass-subpage path: map fills the scroller with a 100% chain, no viewport math',
  html().includes('.container.mapview { padding:0; height:100%; box-sizing:border-box; }')
  && html().includes('.stage { height:100%; min-height:360px; }'));
